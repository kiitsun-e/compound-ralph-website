...
Compound Ralph auto-detects your project type and sets appropriate gates.
...
- [Ralph Loop](/concepts/ralph-loop) - The iteration cycle that runs backpressure
- [borg implement](/commands/implement) - Command that executes the loop
- [borg review](/commands/review) - Code review as additional backpressure
